...
struct page_t
{
    ...
    uint32_t rw        : 1;  /* Rw if set, ro otherwise */
...
struct page_directory_t
{
    ...
    /* The physical location of the above tables_physical. Needed when
     * the kernel heap is allocated and therefore the page directory
     * might be in a different physical location in relation to the
